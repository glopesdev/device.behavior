...
namespace Harp.Behavior
{
    ...
    public partial class PwmStart
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((PwmOutputs)payload, timestamp);
        }
    ...
    public partial class EventEnable
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((Events)payload, timestamp);
        }
    ...
    public partial class StartCameras
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((CameraOutputs)payload, timestamp);
        }
    ...
    public partial class EnableServos
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((ServoOutputs)payload, timestamp);
        }
    ...
    public partial class EnableEncoders
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((EncoderInputs)payload, timestamp);
        }
    ...
    public partial class Camera0Frame
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((FrameAcquired)payload, timestamp);
        }
    ...
    public partial class EnableSerialTimestamp
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((SerialTimestampPorts)payload, timestamp);
        }
    ...
    public partial class MimicPort0IR
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((MimicOutput)payload, timestamp);
        }
